                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div>
                                                            ...
                                                            <p className="text-slate-800 font-medium">{inquiry.budget}</p>
                                                        </div>
                                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <div className="bg-white p-4 rounded-lg border border-slate-200">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        <button 
                                                            onClick={(e) => { e.stopPropagation(); inquiry.id && handleStatusChange(inquiry.id, 'new'); }}
                                                        ...
                                                        <button 
                                                            onClick={(e) => { e.stopPropagation(); inquiry.id && handleStatusChange(inquiry.id, 'contacted'); }}
                                                        ...
                                                        <button 
                                                            onClick={(e) => { e.stopPropagation(); inquiry.id && handleStatusChange(inquiry.id, 'closed'); }}
